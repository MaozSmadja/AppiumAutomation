...
function extractProtocol(driver) {
  ...
  var dstDriver = _lodash2['default'].isFunction(driver.driverForSession) ? driver.driverForSession(sessionId) : driver;
  if (dstDriver === driver) {
...
function buildHandler(app, method, path, spec, driver, isSessCmd) {
  ...
  var asyncHandler = function asyncHandler(req, res) {
    var jsonObj, httpResBody, httpStatus, newSessionId, currentProtocol, args, driverRes, actualErr, errMsg, _getResponseForW3CError, _getResponseForW3CError2, _getResponseForJsonwpError, _getResponseForJsonwpError2, jsonwpRes, w3cRes;
      ...
      while (1) switch (context$2$0.prev = context$2$0.next) {
        ...
        case 14:
          ...
          if (spec.command === CREATE_SESSION_COMMAND) {
            ...
            currentProtocol = _basedriverDriver2['default'].determineProtocol.apply(_basedriverDriver2['default'], _toConsumableArray(makeArgs(req.params, jsonObj, spec.payloadParams || {})));
          }
          ...
          getLogByProtocol(currentProtocol).debug('Calling ' + driver.constructor.name + '.' + spec.command + '() with args: ' + _lodash2['default'].truncate(JSON.stringify(args), { length: LOG_OBJ_LENGTH }));
        ...
        case 31:
          ...
          if (!(_lodash2['default'].isPlainObject(driverRes) && _lodash2['default'].has(driverRes, 'protocol'))) {
            context$2$0.next = 37;
            break;
          }
        ...
        case 37:
          ...
          if (spec.command === CREATE_SESSION_COMMAND) {
            ...
            getLogByProtocol(currentProtocol).debug('Cached the protocol value \'' + currentProtocol + '\' for the new session ' + newSessionId);
          ...
          if (spec.command === DELETE_SESSION_COMMAND) {
            getLogByProtocol(currentProtocol).debug('Received response: ' + _lodash2['default'].truncate(JSON.stringify(driverRes), { length: LOG_OBJ_LENGTH }));
        ...
        case 48:
          ...
          getLogByProtocol(currentProtocol).debug('Responding to client with driver.' + spec.command + '() ' + ('result: ' + _lodash2['default'].truncate(JSON.stringify(driverRes), { length: LOG_OBJ_LENGTH })));
          context$2$0.next = 62;
          break;
        ...
        case 53:
          ...
          getLogByProtocol(currentProtocol).debug('Encountered internal error running command: ' + errMsg);
          ...
          } else if (currentProtocol === _basedriverDriver2['default'].DRIVER_PROTOCOL.MJSONWP) {
